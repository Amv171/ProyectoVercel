    ...
    >
      ...
      <div className={`flex justify-between items-center px-6 py-4 ${darkMode ? "bg-blue-700" : "bg-blue-600"}`}>
        <Link href="/" className="text-white text-lg font-semibold flex items-center gap-2">
          ...
          Pág. Perfil usuario ADMIN
        </Link>
        <div className={`${darkMode ? "bg-gray-600" : "bg-white"} px-4 py-1 rounded-md font-bold`}>LOGO</div>
      </div>
      ...
      <div className={`flex-1 w-full px-6 py-6 ${darkMode ? "bg-gray-800" : "bg-white"}`}>
        ...
        <div className="p-6 flex flex-col gap-8">
          ...
          <div>
            ...
            <div className="flex flex-wrap gap-2">
             <button
              ...
              <button onClick={() =>alert("En desarrollo")} className={`px-4 py-2 font-bold rounded ${darkMode ? "bg-gray-600 text-white" : "bg-gray-300"}`}>
          ...
          {/* AJUSTES */}
          <div>
            <h4 className="font-bold mb-2">AJUSTES</h4>
            <div className="flex flex-wrap gap-2">
              <button onClick={() => router.push("/admin-cuentas")} className={`px-4 py-2 font-bold rounded ${darkMode ? "bg-gray-600 text-white" : "bg-gray-300"}`}>
                GESTIÓN DE CUENTAS
              </button>
            </div>
          </div>
            ...
            <div className={`mb-4 p-4 rounded-md flex justify-between items-center ${darkMode ? "bg-gray-600" : "bg-gray-300"}`}>
              ...
              <button
                ...
                className={`w-10 h-6 flex items-center rounded-full p-1 transition-colors duration-300 ${
                  darkMode ? "bg-green-600 justify-end" : "bg-black justify-start"
                }`}
              >
